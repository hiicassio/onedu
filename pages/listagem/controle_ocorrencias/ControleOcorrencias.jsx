...
import styles from './ControleOcorrencias.module.scss';
...
const ControleOcorrencias = () => {
    ...
    return (
        <div className={styles.containerControleOcorrencias}>
            {loading ?
                <Loading />
                :
                <>
                    ...
                    <div className={styles.tableArea}>
                        <div className={styles.table}>
                            <div className={styles.header}>
                                ...
                                <div className={styles.th}>SETOR</div>
                            ...
                            <div className={styles.body}>
                                ...
                                `
                                        ...
                                        <div key={index} className={styles.row}>
                                            ...
                                            <div className={styles.td}>{student.setor}</div>
                                            <div className={styles.td}>{student.categoria}</div>
                                            <div className={styles.td}>
                                                <button
                                                    className={`
                                                            ${student.situacao === 1 ? styles.concluido : student.situacao === 0 ? styles.pendente : styles.analise}
                                                        `}
                                                >
                                                    {student.situacao === 1 ? 'Concluído' : student.situacao === 0 ? 'Pendente' : 'Em Análise'}
                                                </button>
